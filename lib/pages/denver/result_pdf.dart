...
bool _useDesktopResultPdfLayout(BuildContext context) {
...
class _ResultPdfState extends State<ResultPdf> {
  ...
  Future<Uint8List> makePdf() async {
    ...
    final ByteData logoBytes =
        await rootBundle.load('assets/Growcheck-logo.png');
    ...
    bool hasNoOpportunityForDomain(String domainKey) {
      ...
      for (final item in items) {
        final disp =
            (item['score_for_pdf'] ?? scoreDisplay(item['score'])).toString();
    ...
    final personalStatus =
        statusForDomain('Personal Social', widget.agePersonal);
          ...
          return [
                  ...
                  pw.Table(
                    ...
                    children: [
                      ...
                      pw.TableRow(children: [
                        ...
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text(widget.studentName)),
                      ]),
                      pw.TableRow(children: [
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                        ...
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text(widget.ageString)),
                      ]),
                      pw.TableRow(children: [
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text('Assessment Date')),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                    ...
                    children: [
                      pw.TableRow(
                        ...
                        children: [
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text('Domain',
                                style: pw.TextStyle(
                                    fontWeight: pw.FontWeight.bold)),
                          ),
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text('Dev Age (Months)',
                                style: pw.TextStyle(
                                    fontWeight: pw.FontWeight.bold)),
                          ),
                          pw.Padding(
                      ...
                      pw.TableRow(children: [
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text('Fine Motor')),
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text(widget.ageFineMotor.toString())),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text(fineStatus,
                              style: pw.TextStyle(
                                  color: colorForStatus(fineStatus))),
                        ),
                      ]),
                      pw.TableRow(children: [
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text('Gross Motor')),
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text(widget.ageGrossMotor.toString())),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text(grossStatus,
                              style: pw.TextStyle(
                                  color: colorForStatus(grossStatus))),
                        ),
                      ]),
                      pw.TableRow(children: [
                        pw.Padding(
                        ...
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text(widget.ageLanguage.toString())),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text(languageStatus,
                              style: pw.TextStyle(
                                  color: colorForStatus(languageStatus))),
                        ),
                      ]),
                      pw.TableRow(children: [
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text('Personal Social')),
                        pw.Padding(
                            padding: const pw.EdgeInsets.all(8),
                            child: pw.Text(widget.agePersonal.toString())),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(8),
                          child: pw.Text(personalStatus,
                              style: pw.TextStyle(
                                  color: colorForStatus(personalStatus))),
                        ),
                      ]),
                    ],
                  ),
            ...
            pw.Container(
              ...
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Fail Components',
                      style: pw.TextStyle(
                          fontSize: 18, fontWeight: pw.FontWeight.bold)),
                  pw.SizedBox(height: 10),
                  if (groupedFailData.isEmpty)
                    pw.Text("No fail components.",
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  if (suggestions.isEmpty)
                    pw.Text("No suggestions available.",
                        style: const pw.TextStyle(fontSize: 14))
                  else
                    ...suggestions.map((sug) => pw.Padding(
                          padding: const pw.EdgeInsets.symmetric(vertical: 4),
                          child: pw.Text("• ${sug['suggestion']}",
                              style: const pw.TextStyle(fontSize: 14)),
                        )),
                  pw.SizedBox(height: 20),
                  ...
                  if (recommendations.isEmpty)
                    ...
                    ...recommendations.map((rec) => pw.Padding(
                          padding: const pw.EdgeInsets.symmetric(vertical: 4),
                          child: pw.Text("• ${rec['recommendation']}",
                              style: const pw.TextStyle(fontSize: 14)),
                        )),
                  pw.SizedBox(height: 20),
                  pw.Text('Intervention Plan',
                      style: pw.TextStyle(
                          fontSize: 18, fontWeight: pw.FontWeight.bold)),
                  pw.Divider(),
                  pw.SizedBox(height: 10),
                  if (interventions.isEmpty)
                    pw.Text("No intervention plan available.",
                        style: const pw.TextStyle(fontSize: 14))
                  else
            ...
            pw.Container(
              ...
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Therapist Note/Comment',
                      style: pw.TextStyle(
                          fontSize: 18, fontWeight: pw.FontWeight.bold)),
                  pw.SizedBox(height: 10),
                  pw.Text(widget.therapist_suggestion,
                      style: const pw.TextStyle(fontSize: 14)),
                  pw.SizedBox(height: 20),
                  pw.Text('Rujukan:',
                      style: pw.TextStyle(
                  ...
                  pw.Bullet(
                      text:
                          'Garis panduan oleh Kementerian Pendidikan Malaysia',
                      style: const pw.TextStyle(fontSize: 14)),
                  pw.Bullet(
                      text:
                          'Case-Smith\'s Occupational Therapy Practice Framework',
                      style: const pw.TextStyle(fontSize: 14)),
                  pw.Bullet(
                      text: 'Disemak mengikut piawaian perkembangan global',
                      style: const pw.TextStyle(fontSize: 14)),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    if (_useDesktopResultPdfLayout(context)) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Full Result PDF',
                      ...
                      _glassCard(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                _summaryRow('Suggestion', suggestions.length,
                                    Icons.lightbulb_rounded),
                                const SizedBox(width: 10),
                                _summaryRow('Advice', recommendations.length,
                                    Icons.checklist_rounded),
                                const SizedBox(width: 10),
                                _summaryRow('Interventions',
                                    interventions.length, Icons.route_rounded),
                                const SizedBox(width: 10),
                                _summaryRow(
                                    'Fail Items',
                                    widget.failData.length,
                ...
                child: ConstrainedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      SizedBox(
                        width: 320,
                        child: _desktopReportSidebar(),
                      ),
                      const SizedBox(width: 20),
                      Expanded(child: _desktopPdfWorkspace()),
                    ],
                  ),
                ),
              ),
      ...
      child: Column(
        ...
        children: [
          _desktopSurface(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 18),
                _desktopDetailRow(Icons.cake_outlined, 'Age', widget.ageString),
                const SizedBox(height: 12),
                _desktopDetailRow(
                  Icons.calendar_today_outlined,
                  'Screening date',
                  _desktopScreeningDate(),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Growkids.purple.withValues(alpha: 0.07),
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: Growkids.purple.withValues(alpha: 0.12),
              ),
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Use the toolbar in the preview to print or save this report.',
                    style: TextStyle(
  ...
  Widget _desktopDetailRow(IconData icon, String label, String value) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, size: 18, color: const Color(0xFF858A99)),
  ...
  String _desktopScreeningDate() {
    final parsed = DateTime.tryParse(widget.screeningDate);
    return parsed == null
