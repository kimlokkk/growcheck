...
class KssReportPreviewPage extends StatelessWidget {
  ...
  String get _semester =>
      reportingPeriod == 'SEM2' ? 'Semester 2' : 'Semester 1';
          ...
          pw.Row(children: [
            ...
            pw.Expanded(
                child: pw.Column(
                    ...
                    children: [
                  pw.Text('KSS STUDENT ASSESSMENT REPORT',
                      style: pw.TextStyle(
                          fontSize: 16,
                          fontWeight: pw.FontWeight.bold,
                          color: PdfColor.fromHex('#17324D'))),
                  pw.SizedBox(height: 3),
                  pw.Text('$_semester - ${classData['academic_year'] ?? ''}',
                      style: pw.TextStyle(
                          fontSize: 10, fontWeight: pw.FontWeight.bold)),
                ])),
          ]),
          pw.SizedBox(height: 8),
          pw.Divider(color: PdfColor.fromHex('#2F5D7C'), thickness: 1.5),
        ]),
        ...
        build: (_) => [
            ...
            child: pw.Row(
                ...
                children: [
                  ...
                  pw.Container(
                    ...
                    decoration: pw.BoxDecoration(
                        color: _pdfTpBg(overallTp),
                        borderRadius: pw.BorderRadius.circular(7)),
                    child: pw.Column(children: [
                      pw.Text('OVERALL TP',
                          style: pw.TextStyle(
                              fontSize: 7, fontWeight: pw.FontWeight.bold)),
                      pw.Text('TP$overallTp',
                          style: pw.TextStyle(
                              fontSize: 19,
                              fontWeight: pw.FontWeight.bold,
                              color: _pdfTpColor(overallTp))),
                    ]),
                  ),
                ]),
          ),
          ...
          ...domains.values.expand((domainStandards) sync* {
            ...
            yield pw.Container(
              ...
              color: PdfColor.fromHex('#DCE7F0'),
              child: pw.Text(
                  '${first['domain_code']}  ${first['domain_title']}',
                  style: pw.TextStyle(
                      fontSize: 11,
                      fontWeight: pw.FontWeight.bold,
                      color: PdfColor.fromHex('#17324D'))),
            ...
            for (var index = 0; index < domainStandards.length; index++) {
              ...
              final resultRaw =
                  results[standard['content_standard_id'].toString()];
  ...
  pw.Widget _pdfStandard(Map<String, dynamic> standard,
      Map<String, dynamic> result, Map<String, dynamic> observations, int? tp) {
      ...
      child:
        ...
        pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          pw.Container(
            ...
            alignment: pw.Alignment.center,
            decoration: pw.BoxDecoration(
                color: tp == null ? PdfColors.grey200 : _pdfTpBg(tp),
                borderRadius: pw.BorderRadius.circular(5)),
            child: pw.Text(tp == null ? '-' : 'TP$tp',
                style: pw.TextStyle(
                    fontWeight: pw.FontWeight.bold,
                    color: tp == null ? PdfColors.grey700 : _pdfTpColor(tp))),
          ),
          pw.SizedBox(width: 8),
          pw.Expanded(
              child: pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                pw.Text('SK ${standard['sk_code']}',
                    style: pw.TextStyle(
                        fontSize: 9,
                        fontWeight: pw.FontWeight.bold,
                        color: PdfColor.fromHex('#17324D'))),
                pw.Text((standard['sk_statement'] ?? '-').toString(),
                    style: pw.TextStyle(
                ...
                if ((result['interpretation'] ?? '')
                    ...
                    .isNotEmpty) ...[
                  pw.SizedBox(height: 3),
                  pw.Text('Tafsiran: ${result['interpretation']}',
                      style: const pw.TextStyle(
        ...
        if (learning.isNotEmpty) ...[
          ...
          ...learning.map((sp) {
            ...
            final obs =
                obsRaw is Map ? Map<String, dynamic>.from(obsRaw) : null;
            return pw.Container(
              width: double.infinity,
              ...
              child: pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text('SP ${sp['sp_code']}  ${sp['sp_statement']}',
  ...
  PdfColor _pdfTpBg(int tp) => tp <= 2
      ? PdfColor.fromHex('#F4CCCC')
      : tp <= 4
          ? PdfColor.fromHex('#FFF2CC')
          : PdfColor.fromHex('#D9EAD3');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PdfPreview(
        ...
        pdfFileName:
            'KSS_${safeName}_${reportingPeriod}_${classData['academic_year'] ?? ''}.pdf',
      ),
    );
  }
}
